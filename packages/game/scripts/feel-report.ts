...
export async function runFeelReport(): Promise<FeelReportBundle> {
  ...
  const report: Record<string, unknown> = {
    ...
    configEcho: {
      'locomotion.steerHeadingBiasGain': cfg.locomotion.steerHeadingBiasGain,
      'locomotion.steerYawGain': cfg.locomotion.steerYawGain,
      'locomotion.rideMotionFullSpeed': cfg.locomotion.rideMotionFullSpeed,
